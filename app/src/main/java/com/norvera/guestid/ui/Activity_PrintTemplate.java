...
public class Activity_PrintTemplate extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setMDialog(new MsgDialog(this));
        setMHandle(new MsgHandle(this, getMDialog()));
        setMyPrint(new TemplatePrint(this, getMHandle(), getMDialog()));

        // when use bluetooth print set the adapter
        BluetoothAdapter bluetoothAdapter = super.getBluetoothAdapter();
        getMyPrint().setBluetoothAdapter(bluetoothAdapter);
    ...
    public void printButtonOnClick() {
        ...
        if (listItems.size() > 0) {
            ...
            ((TemplatePrint) getMyPrint()).setEncoding((String) mSpinnerEncoding
                    .getSelectedItem());

            ((TemplatePrint) getMyPrint()).setPrintData(listItems);
            getMyPrint().print();
        }
    }
    ...
    private boolean checkNewInputData() {
        ...
        if (errorInput) {
            getMDialog().showAlertDialog(getString(R.string.msg_title_warning),
